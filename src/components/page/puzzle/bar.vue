      ...
      <div class="swiper-container" id="pie_swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide form">
            ...
            <div class="group" v-for="s in op.series">
              <p>
                <o-input label="系列名称" placeholder="请输入系列名称" v-model="s.name" type="single"></o-input>
              </p>
              <p>
                <o-select label="数据项" placeholder="请选择显示数据的属性" type="single" :data="keys" v-model="s.value"></o-select>
              </p>
              <span class="icon">
                <o-svg type="plus"></o-svg>
              </span>
            </div>
          </div>
